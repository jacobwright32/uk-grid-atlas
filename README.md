...
for all thirty-two grids, with no key and no required dependencies.
...
`#fr`, `#de`, `#ch`, `#at`, `#cz`, `#si`, `#hu`, `#sk`, `#hr`, `#bg`, `#gr`, `#ro`, `#ba`, `#rs`, `#mk`, `#no`, `#se`, `#fi`, `#pl`, `#es`, `#pt`, `#it`, `#ee`, `#lv`, `#lt`, `#us`, `#ca`, `#all` in the URL)
swaps data bundles, map bounds and voltage tiers per country. Thirty-two grids
...
the thirty-two grids have queries in `scripts/fetch-overpass.mjs` — `gb`, `no`,
`se`, `pl`, `pt`, `fi`, `ch`, `at`, `cz`, `ee`, `lv`, `lt`, `es`, `it`. The
other eighteen — **`nl`, `be`, `ie`, `dk`, `fr`, `de`, `si`, `hu`, `sk`, `hr`, `bg`, `gr`, `ro`, `ba`, `rs`, `mk`, `ca`, `us`** — have none at
