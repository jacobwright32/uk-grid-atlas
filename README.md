...
- **~60,000 generation sites across twenty-four grids on two continents** —
...
for all twenty-four grids, with no key and no required dependencies.
...
`#fr`, `#de`, `#ch`, `#at`, `#cz`, `#si`, `#hu`, `#no`, `#se`, `#fi`, `#pl`, `#es`, `#pt`, `#it`, `#ee`, `#lv`, `#lt`, `#us`, `#ca`, `#all` in the URL)
swaps data bundles, map bounds and voltage tiers per country. Twenty-four grids
...
Hungary (400/220; the 120 kV layer is barely mapped in OSM, and the single 750 kV line to Ukraine is omitted), Norway (420/300/132), Sweden (400/220/130), Poland
...
the twenty-four grids have queries in `scripts/fetch-overpass.mjs` — `gb`, `no`,
`se`, `pl`, `pt`, `fi`, `ch`, `at`, `cz`, `ee`, `lv`, `lt`, `es`, `it`. The
other ten — **`nl`, `be`, `ie`, `dk`, `fr`, `de`, `si`, `hu`, `ca`, `us`** — have none at
...
Geofabrik country download. Slovenia and Hungary are smaller but were added
the PBF way because it is now the more reliable of the two paths. Several Overpass countries also carry a
