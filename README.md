...
- **~60,000 generation sites across twenty-seven grids on two continents** —
...
for all twenty-seven grids, with no key and no required dependencies.
...
`#fr`, `#de`, `#ch`, `#at`, `#cz`, `#si`, `#hu`, `#sk`, `#hr`, `#bg`, `#no`, `#se`, `#fi`, `#pl`, `#es`, `#pt`, `#it`, `#ee`, `#lv`, `#lt`, `#us`, `#ca`, `#all` in the URL)
swaps data bundles, map bounds and voltage tiers per country. Twenty-seven grids
...
Hungary (400/220; the 120 kV layer is barely mapped in OSM, and the single 750 kV line to Ukraine is omitted), Slovakia (400/220/110), Croatia (400/220/110), Bulgaria (400/220/110), Norway (420/300/132), Sweden (400/220/130), Poland
...
the twenty-seven grids have queries in `scripts/fetch-overpass.mjs` — `gb`, `no`,
`se`, `pl`, `pt`, `fi`, `ch`, `at`, `cz`, `ee`, `lv`, `lt`, `es`, `it`. The
other thirteen — **`nl`, `be`, `ie`, `dk`, `fr`, `de`, `si`, `hu`, `sk`, `hr`, `bg`, `ca`, `us`** — have none at
