...
thirteen European countries, the United States, and a transatlantic ALL view:
...
- **Tens of thousands of generation sites across fifteen grids** — nuclear, gas, offshore/onshore wind, solar,
...
`#fr`, `#de`, `#no`, `#se`, `#fi`, `#pl`, `#es`, `#pt`, `#it`, `#us`, `#all` in the URL)
swaps data bundles, map bounds and voltage tiers per country. Fifteen grids
