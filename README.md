...
- **~60,000 generation sites across twenty-eight grids on two continents** —
...
for all twenty-eight grids, with no key and no required dependencies.
...
`#fr`, `#de`, `#ch`, `#at`, `#cz`, `#si`, `#hu`, `#sk`, `#hr`, `#bg`, `#gr`, `#no`, `#se`, `#fi`, `#pl`, `#es`, `#pt`, `#it`, `#ee`, `#lv`, `#lt`, `#us`, `#ca`, `#all` in the URL)
swaps data bundles, map bounds and voltage tiers per country. Twenty-eight grids
...
Hungary (400/220; the 120 kV layer is barely mapped in OSM, and the single 750 kV line to Ukraine is omitted), Slovakia (400/220/110), Croatia (400/220/110), Bulgaria (400/220/110), Greece (400/150 — Portugal's shape; island 66 kV systems omitted), Norway (420/300/132), Sweden (400/220/130), Poland
...
the twenty-eight grids have queries in `scripts/fetch-overpass.mjs` — `gb`, `no`,
`se`, `pl`, `pt`, `fi`, `ch`, `at`, `cz`, `ee`, `lv`, `lt`, `es`, `it`. The
other fourteen — **`nl`, `be`, `ie`, `dk`, `fr`, `de`, `si`, `hu`, `sk`, `hr`, `bg`, `gr`, `ca`, `us`** — have none at
