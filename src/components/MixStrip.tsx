 ...
 */
export default function MixStrip({ mix, rows, isSnapshot }: Props) {
  ...
  return (
    <div className="mixstrip" role="figure" aria-label="Current GB generation vs fleet capacity">
      ...
      <div className="mixstrip-legend">
        <span className="mixstrip-item">bright = generating now · ghost = metered-fleet capacity</span>
